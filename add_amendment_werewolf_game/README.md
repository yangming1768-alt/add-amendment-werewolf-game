...
项目的完整设计过程记录在 `PRD_and_Text/` 目录下：

| 文档 | 内容 |
|------|------|
| `AMENDMENT_PHASE.md` | 修正案阶段 6 步流程的详细执行说明 |
| `CONFIG_INJECTION.md` | GameConfig 中间层 + apply_amendment 注入逻辑 |
| `GAME_INTEGRATION.md` | 游戏代码 5 个配置注入点的具体改动说明 |
| `狼人杀游戏调研.md` | 狼人杀规则调研 |
| `投票制度调研.md` | 议会投票制度调研 |
